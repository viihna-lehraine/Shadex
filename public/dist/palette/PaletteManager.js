...
class PaletteManager {
    ...
    constructor(stateManager, common, generateHues, generatePaletteFns, generatePalette) {
        ...
        console.log('[PaletteManager.constructor] Argument 1 - stateManager', stateManager);
        console.log(`[PaletteManager.constructor] Argument 2 - Common Fn Group`, common);
        console.log(`[PaletteManager.constructor] Argument 3 - Generate Hues Fn Group`, generateHues);
        console.log(`[PaletteManager.constructor] Argument 4 - Generate Palette Fn Group`, generatePaletteFns);
        console.log(`[PaletteManager.constructor] Argument 5 - Generate Palette Fn`, generatePalette);
    ...
    handleColumnResize(columnID, newSize) {
        ...
        const unlockedColumns = columns.filter((__, i) => i !== columnIndex && !columns[i].isLocked);
