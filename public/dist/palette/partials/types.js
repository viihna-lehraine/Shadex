...
function analogous(options, common, generateHues) {
    ...
    try {
        ...
        errors.handle(error, 'Error generating analogous palette. Returning default.', 'analogous()', {
            options: options
        }, 'error');
...
function complementary(options, common) {
    try {
        ...
        common.services.errors.handle(error, 'Error generating complementary palette. Returning default.', 'complementary()', {
            options: options
        }, 'error');
        return data.defaults.palette;
    }
...
function diadic(options, common, generateHues) {
    try {
        ...
        common.services.errors.handle(error, 'Error generating diadic palette. Returning default.', 'diadic()', {
            options: options
        }, 'error');
        return data.defaults.palette;
    }
...
function hexadic(options, common, generateHues) {
    try {
        ...
        common.services.errors.handle(error, 'Error generating hexadic palette. Returning default.', 'hexadic()', {
            options: options
        }, 'error');
        return data.defaults.palette;
    }
...
function monochromatic(options, common) {
    try {
        ...
        common.services.errors.handle(error, 'Error generating monochromatic palette. Returning default.', 'monochromatic()', {
            options: options
        }, 'error');
        return data.defaults.palette;
    }
...
function random(options, common) {
    try {
        ...
        common.services.errors.handle(error, 'Error generating random palette. Returning default.', 'random()', {
            options: options
        }, 'error');
        return data.defaults.palette;
    }
...
function splitComplementary(options, common) {
    try {
        ...
        common.services.errors.handle(error, 'Error generating split-complementary palette. Returning default.', 'splitComplementary()', {
            options: options
        }, 'error');
        return data.defaults.palette;
    }
...
function tetradic(options, common, generateHues) {
    try {
        ...
        common.services.errors.handle(error, 'Error generating tetradic palette. Returning default.', 'tetradic()', {
            options: options
        }, 'error');
        return data.defaults.palette;
    }
...
function triadic(options, common, generateHues) {
    try {
        ...
        common.services.errors.handle(error, 'Error generating triadic palette. Returning default.', 'triadic()', {
            options: options
        }, 'error');
        return data.defaults.palette;
    }
