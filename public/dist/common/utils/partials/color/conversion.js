...
function colorConversionUtilsFactory(adjust, brand, format, helpers, sanitize, services, validate) {
    const { color: { hueToRGB }, data: { clone } } = helpers;
    const { errors, log } = services;
    function cmykToHSL(cmyk) {
        return errors.handleSync(() => {
            if (!validate.colorValue(cmyk)) {
                log(`Invalid CMYK value ${JSON.stringify(cmyk)}. Returning default HSL`, {
                    caller: 'utils.color.cmykToHSL',
                    level: 'error'
                });
                return defaultHSL;
            }
    ...
    function cmykToRGB(cmyk) {
        return errors.handleSync(() => {
            if (!validate.colorValue(cmyk)) {
                log(`Invalid CMYK value ${JSON.stringify(cmyk)}. Returning default RGB.`, {
                    caller: 'utils.color.cmykToRGB',
                    level: 'error'
                });
                return defaultRGB;
            }
    ...
    function convertHSL(color, colorSpace) {
        return errors.handleSync(() => {
            if (!validate.colorValue(color)) {
                log(`Invalid color value ${JSON.stringify(color)}. Returning default HSL.`, {
                    caller: 'utils.color.convertHSL',
                    level: 'error'
                });
                return defaultHSL;
            }
    ...
    function convertToHSL(color) {
        return errors.handleSync(() => {
            if (!validate.colorValue(color)) {
                log(`Invalid color value ${JSON.stringify(color)}. Returning default HSL`, {
                    caller: 'utils.color.convertToHSL',
                    level: 'error'
                });
                return defaultHSL;
            }
    ...
    function hexToHSL(hex) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hex)) {
                log(`Invalid Hex value ${JSON.stringify(hex)}. Returning default HSL`, {
                    caller: 'utils.color.hexToHSL',
                    level: 'error'
                });
                return defaultHSL;
            }
    ...
    function hexToRGB(hex) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hex)) {
                log(`Invalid Hex value ${JSON.stringify(hex)}. Returning default RGB`, {
                    caller: 'utils.color.hexToRGB',
                    level: 'error'
                });
                return defaultRGB;
            }
    ...
    function hslToCMYK(hsl) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hsl)) {
                log(`Invalid HSL value ${JSON.stringify(hsl)}. Returning default CMYK.`, {
                    caller: 'utils.color.hslToCMYK',
                    level: 'error'
                });
                return defaultCMYK;
            }
    ...
    function hslToHex(hsl) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hsl)) {
                log(`Invalid HSL value ${JSON.stringify(hsl)}. Returning default Hex`, {
                    caller: 'utils.color.hslToHex',
                    level: 'error'
                });
                return defaultHex;
            }
    ...
    function hslToHSV(hsl) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hsl)) {
                log(`Invalid HSL value ${JSON.stringify(hsl)}. Returning default HSV`, {
                    caller: 'utils.color.hslToHSV',
                    level: 'error'
                });
                return defaultHSV;
            }
    ...
    function hslToLAB(hsl) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hsl)) {
                log(`Invalid HSL value ${JSON.stringify(hsl)}. Returning default LAB`, {
                    caller: 'utils.color.hslToLAB',
                    level: 'error'
                });
                return defaultLAB;
            }
    ...
    function hslToRGB(hsl) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hsl)) {
                log(`Invalid HSL value ${JSON.stringify(hsl)}. Returning default RGB`, {
                    caller: 'utils.color.hslToRGB',
                    level: 'error'
                });
                return defaultRGB;
            }
    ...
    function hslToSL(hsl) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hsl)) {
                log(`Invalid HSL value ${JSON.stringify(hsl)}. Returning default SL`, {
                    caller: 'utils.color.hslToSL',
                    level: 'error'
                });
                return defaultSL;
            }
    ...
    function hslToSV(hsl) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hsl)) {
                log(`Invalid HSL value ${JSON.stringify(hsl)}. Returning default SV`, {
                    caller: 'utils.color.hslToSV',
                    level: 'error'
                });
                return defaultSV;
            }
    ...
    function hslToXYZ(hsl) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hsl)) {
                log(`Invalid HSL value ${JSON.stringify(hsl)}. Returning default HSL.`, {
                    caller: 'utils.color.hslToXYZ',
                    level: 'error'
                });
                return defaultXYZ;
            }
    ...
    function hsvToHSL(hsv) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hsv)) {
                log(`Invalid HSV value ${JSON.stringify(hsv)}. Returning default HSL`, {
                    caller: 'utils.color.hsvToHSL',
                    level: 'error'
                });
                return defaultHSL;
            }
    ...
    function hsvToSV(hsv) {
        return errors.handleSync(() => {
            if (!validate.colorValue(hsv)) {
                log(`Invalid HSV value ${JSON.stringify(hsv)}. Returning default SV`, {
                    caller: 'utils.color.hsvToSV',
                    level: 'error'
                });
                return defaultSV;
            }
    ...
    function labToHSL(lab) {
        return errors.handleSync(() => {
            if (!validate.colorValue(lab)) {
                log(`Invalid LAB value ${JSON.stringify(lab)}. Returning default HSL.`, {
                    caller: 'utils.color.labToHSL',
                    level: 'error'
                });
                return defaultHSL;
            }
    ...
    function labToRGB(lab) {
        return errors.handleSync(() => {
            if (!validate.colorValue(lab)) {
                log(`Invalid LAB value ${JSON.stringify(lab)}. . Returning default RGB.`, {
                    caller: 'utils.color.labToRGB',
                    level: 'error'
                });
                return defaultRGB;
            }
    ...
    function labToXYZ(lab) {
        return errors.handleSync(() => {
            if (!validate.colorValue(lab)) {
                log(`Invalid LAB value ${JSON.stringify(lab)}. Returning default XYZ.`, {
                    caller: 'utils.color.labToXYZ',
                    level: 'error'
                });
                return defaultXYZ;
            }
    ...
    function rgbToCMYK(rgb) {
        return errors.handleSync(() => {
            if (!validate.colorValue(rgb)) {
                log(`Invalid RGB value ${JSON.stringify(rgb)}.. Returning default CMYK`, {
                    caller: 'utils.color.rgbToCMYK',
                    level: 'error'
                });
                return defaultCMYK;
            }
            ...
            log(`Converted RGB ${JSON.stringify(clonedRGB)} to CMYK: ${JSON.stringify(clone(cmyk))}`, {
                caller: 'utils.color.rgbToCMYK',
                level: 'debug'
            });
            return cmyk;
    ...
    function rgbToHex(rgb) {
        return errors.handleSync(() => {
            if (!validate.colorValue(rgb)) {
                log(`Invalid RGB value ${JSON.stringify(rgb)}. . Returning default Hex.`, {
                    caller: 'utils.color.rgbToHex',
                    level: 'error'
                });
                return defaultHex;
            }
    ...
    function rgbToHSL(rgb) {
        return errors.handleSync(() => {
            if (!validate.colorValue(rgb)) {
                log(`Invalid RGB value ${JSON.stringify(rgb)}. Returning default HSL.`, {
                    caller: 'utils.color.rgbToHSL',
                    level: 'error'
                });
                return defaultHSL;
            }
    ...
    function rgbToHSV(rgb) {
        return errors.handleSync(() => {
            if (!validate.colorValue(rgb)) {
                log(`Invalid RGB value ${JSON.stringify(rgb)}. Returning default HSV.`, {
                    caller: 'utils.color.rgbToHSV',
                    level: 'error'
                });
                return defaultHSV;
            }
    ...
    function rgbToXYZ(rgb) {
        return errors.handleSync(() => {
            if (!validate.colorValue(rgb)) {
                log(`Invalid RGB value ${JSON.stringify(rgb)}. Returning default XYZ`, {
                    caller: 'utils.color.rgbToXYZ',
                    level: 'error'
                });
                return defaultXYZ;
            }
    ...
    function xyzToHSL(xyz) {
        return errors.handleSync(() => {
            if (!validate.colorValue(xyz)) {
                log(`Invalid XYZ value ${JSON.stringify(xyz)}. Returning default HSL.`, {
                    caller: 'utils.color.xyzToHSL',
                    level: 'error'
                });
                return defaultHSL;
            }
    ...
    function xyzToLAB(xyz) {
        return errors.handleSync(() => {
            if (!validate.colorValue(xyz)) {
                log(`Invalid XYZ value ${JSON.stringify(xyz)}. Returning default LAB.`, {
                    caller: 'utils.color.xyzToLAB',
                    level: 'error'
                });
                return defaultLAB;
            }
            ...
            if (!validate.colorValue(lab)) {
                log(`Invalid LAB value ${JSON.stringify(lab)}. Returning default LAB.`, {
                    caller: 'utils.color.xyzToLAB',
                    level: 'error'
                });
                return defaultLAB;
    ...
    function xyzToRGB(xyz) {
        return errors.handleSync(() => {
            if (!validate.colorValue(xyz)) {
                log(`Invalid XYZ value ${JSON.stringify(xyz)}. Returning default RGB.`, {
                    caller: 'utils.color.xyzToRGB',
                    level: 'error'
                });
                return defaultRGB;
            }
    ...
    return errors.handleSync(() => {
        return colorConversionUtils;
    }, 'Error creating color conversion utilities');
}
