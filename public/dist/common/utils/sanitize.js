// File: common/utils/sanitize.ts
function sanitationUtilsFactory(brand, services, validate) {
    ...
    return errors.handleSync(() => sanitationUtils, 'Error creating sanitation utils.');
}
