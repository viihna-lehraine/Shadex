...
function typeguardsFactory() {
    const { hasFormat, hasNumericProperties, hasStringProperties, hasValueProperty, isByteRange, isHexSet, isLAB_A, isLAB_B, isLAB_L, isObject, isPercentile, isRadial, isXYZ_X, isXYZ_Y, isXYZ_Z } = microguards;
    ...
    return {
        ...
        isConvertibleColor(color) {
            return (this.isCMYK(color) ||
                this.isHex(color) ||
                this.isHSL(color) ||
                this.isHSV(color) ||
                this.isLAB(color) ||
