...
async function initializeApp() {
    try {
        ...
        const { createHelpers } = await import('../common/factories/helpers.js');
        console.log('[initializeApp()] Loaded createHelpers.');
        const { createServices } = await import('../common/factories/services.js');
        ...
        const paletteEvents = new PaletteEvents(paletteState, services, stateManager, utils);
        ...
        console.log(`[initializeApp()] Services object before return: ${JSON.stringify(services)}`);
        ...
        console.log('[initializeApp()] Reached function end, returning Common Functions Object.');
        return {
        ...
        console.error(`[initializeApp()] Initialization failed: ${error instanceof Error ? error.message : error}`);
        throw error;
    }
}

export { initializeApp as default, initializeApp };
