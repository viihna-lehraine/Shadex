...
import { adjustSaturationAndLightness, generateAndStoreColorValues, populateColorTextOutputBox, randomCMYK, randomHex, randomHSL, randomHSV, randomLab, randomRGB } from '../../export.js';
...
function generateComplementaryPalette(numBoxes, limitGrayAndBlack, limitLight, baseColor = null, initialColorSpace = 'hex') {
    ...
    console.log('generateComplementaryPaletteParameters: ', generateComplementaryPaletteParameters);
