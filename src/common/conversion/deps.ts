// File: common/conversion/deps.js
...
const brandColor = coreUtils.brandColor;
const logger = await createLogger();

const clone = coreUtils.base.clone;

const defaultCMYKUnbranded = clone(defaultColors.cmyk);
const defaultHexUnbranded = clone(defaultColors.hex);
const defaultHSLUnbranded = clone(defaultColors.hsl);
const defaultHSVUnbranded = clone(defaultColors.hsv);
const defaultLABUnbranded = clone(defaultColors.lab);
const defaultRGBUnbranded = clone(defaultColors.rgb);
const defaultSLUnbranded = clone(defaultColors.sl);
const defaultSVUnbranded = clone(defaultColors.sv);
const defaultXYZUnbranded = clone(defaultColors.xyz);
...
function cmykToHSL(cmyk: CMYK, validate: ValidateFn): HSL {
