import { adjustSaturationAndLightness, generateAndStoreColorValues, populateColorTextOutputBox, randomCMYK, randomHex, randomHSL, randomHSV, randomLab, randomRGB } from '../../export';

export function generateComplementaryPalette(numBoxes: number, limitGrayAndBlack: boolean, limitLight: boolean, baseColor: unknown = null, initialColorSpace: string = 'hex') {
    if (numBoxes < 2) {
