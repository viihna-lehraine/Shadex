// File: app/ui/dom/eventListeners/utils.js
...
const event: DOMFn_MasterInterface['utils']['event'] = {
	addEventListener,
...
const file: DOMFn_MasterInterface['utils']['file'] = {
	download,
	readFile
};

export const utils: DOMFn_MasterInterface['utils'] = {
	switchColorSpace,
	event,
	file
};
