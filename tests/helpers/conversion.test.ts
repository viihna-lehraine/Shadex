...
describe('conversionHelpers Module', () => {
    describe('applyGammaCorrection', () => {
        ...
        it('should handle small values without gamma adjustment', () => {
            const correctedValue = conversionHelpers.applyGammaCorrection(0.002);
    ...
    describe('clampRGB', () => {
        ...
        it('should return default RGB on invalid input', () => {
            const invalidRGB = { format: 'rgb', value: { red: 'a', green: 0, blue: 255 } };
    ...
    describe('cmykToHSLHelper', () => {
        it('should convert CMYK to HSL correctly', () => {
            ...
            expect(hsl).toEqual({ format: 'hsl', value: { hue: 0, saturation: 100, lightness: 50 } });
        });
    });
    ...
    describe('cmykToHSVHelper', () => {
        it('should convert CMYK to HSV correctly', () => {
            ...
            expect(hsv).toEqual({ format: 'hsv', value: { hue: 0, saturation: 100, value: 100 } });
        });
    });
    ...
    describe('convertColorToRGB', () => {
        it('should convert Hex to RGB correctly', () => {
            ...
            expect(rgb).toEqual({ format: 'rgb', value: { red: 255, green: 0, blue: 0 } });
        });

        it('should return null for unsupported color formats', () => {
            const unsupportedColor = { format: 'xyz', value: { x: 0, y: 0, z: 0 } };
            const result = conversionHelpers.convertColorToRGB(unsupportedColor as any);
    ...
    describe('convertColorToHex', () => {
        ...
        it('should return null for invalid color values', () => {
            const invalidColor = { format: 'rgb', value: { red: 'a', green: 255, blue: 0 } };
            const result = conversionHelpers.convertColorToHex(invalidColor as any);
    ...
    describe('rgbToHSVHelper', () => {
        it('should convert RGB to HSV correctly', () => {
            const rgb: colors.RGB = { format: 'rgb', value: { red: 0, green: 255, blue: 0 } };
            const hsv = conversionHelpers.rgbToHSVHelper(rgb);
            expect(hsv).toEqual({ format: 'hsv', value: { hue: 120, saturation: 100, value: 100 } });
        });
    });
