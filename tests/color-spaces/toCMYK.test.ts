	...
	describe('hslToCMYK', () => {
		...
		it('should return default CMYK for invalid HSL input', () => {
			const invalidHSL: any = {
				format: 'hsl',
				value: { hue: -1, saturation: 200, lightness: 150 }
			};
	...
	describe('hsvToCMYK', () => {
		...
		it('should return default CMYK for invalid HSV input', () => {
			const invalidHSV: any = {
				format: 'hsv',
				value: { hue: 400, saturation: -10, value: 200 }
			};
