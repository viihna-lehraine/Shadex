...
describe('toRGB Conversion Functions', () => {
    ...
    describe('cmykToRGB', () => {
        ...
        it('should return default RGB for invalid CMYK input', () => {
            const invalidCMYK: any = { format: 'cmyk', value: { cyan: -10, magenta: 100, yellow: 100, key: 0 } };
    ...
    describe('hexToRGB', () => {
        it('should convert valid Hex to RGB', () => {
            const hex: colors.Hex = { format: 'hex', value: { hex: '#00ff00' } };
    ...
    describe('hslToRGB', () => {
        it('should convert valid HSL to RGB', () => {
            const hsl: colors.HSL = { format: 'hsl', value: { hue: 240, saturation: 100, lightness: 50 } };
    ...
    describe('hsvToRGB', () => {
        it('should convert valid HSV to RGB', () => {
            const hsv: colors.HSV = { format: 'hsv', value: { hue: 60, saturation: 100, value: 100 } };
        ...
        it('should return default RGB for invalid HSV input', () => {
            const invalidHSV: any = { format: 'hsv', value: { hue: 400, saturation: 100, value: 100 } };
