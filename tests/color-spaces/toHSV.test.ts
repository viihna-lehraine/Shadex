...
describe('toHSV Conversion Functions', () => {
    ...
    describe('cmykToHSV', () => {
        it('should convert a valid CMYK color to HSV', () => {
            ...
            expect(result.value).toEqual({ hue: 0, saturation: 100, value: 100 });
        });

        it('should return default HSV for invalid CMYK input', () => {
            const invalidCMYK: any = { format: 'cmyk', value: { cyan: -1, magenta: 200, yellow: 100, key: 0 } };
    ...
    describe('hslToHSV', () => {
        ...
        it('should return default HSV for invalid HSL input', () => {
            const invalidHSL: any = { format: 'hsl', value: { hue: -10, saturation: 150, lightness: 300 } };
    ...
    describe('labToHSV', () => {
        ...
        it('should return default HSV for invalid LAB input', () => {
            const invalidLAB: any = { format: 'lab', value: { l: -1, a: 300, b: 200 } };
