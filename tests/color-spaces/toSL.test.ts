...
describe('toSL Conversion Functions', () => {
    ...
    describe('cmykToSL', () => {
        it('should convert valid CMYK to SL', () => {
            ...
            expect(result).toEqual({ value: { saturation: 100, lightness: 50 }, format: 'sl' });
        });

        it('should return default SL for invalid CMYK input', () => {
            const invalidCMYK: any = { format: 'cmyk', value: { cyan: -10, magenta: 120, yellow: 0, key: 0 } };
    ...
    describe('hslToSL', () => {
        it('should convert valid HSL to SL', () => {
            const hsl: colors.HSL = { format: 'hsl', value: { hue: 0, saturation: 100, lightness: 50 } };
            const result = toSL.hslToSL(hsl);
            expect(result).toEqual({ value: { saturation: 100, lightness: 50 }, format: 'sl' });
        });

        it('should return default SL for invalid HSL input', () => {
            const invalidHSL: any = { format: 'hsl', value: { hue: -10, saturation: 120, lightness: 50 } };
    ...
    describe('hsvToSL', () => {
        ...
        it('should return default SL for invalid HSV input', () => {
            const invalidHSV: any = { format: 'hsv', value: { hue: 400, saturation: 120, value: 100 } };
    ...
    describe('labToSL', () => {
        it('should convert valid LAB to SL', () => {
            const lab: colors.LAB = { format: 'lab', value: { l: 50, a: 0, b: 0 } };
            const result = toSL.labToSL(lab);
            expect(result).toEqual({ value: { saturation: 0, lightness: 50 }, format: 'sl' });
        });

        it('should return default SL for invalid LAB input', () => {
            const invalidLAB: any = { format: 'lab', value: { l: -10, a: 120, b: 300 } };
    ...
    describe('rgbToSL', () => {
        ...
        it('should return default SL for invalid RGB input', () => {
            const invalidRGB: any = { format: 'rgb', value: { red: -10, green: 0, blue: 300 } };
    ...
    describe('xyzToSL', () => {
        ...
        it('should return default SL for invalid XYZ input', () => {
            const invalidXYZ: any = { format: 'xyz', value: { x: -10, y: 120, z: 300 } };
