...
describe('DOM palette limits Module', () => {
	const validCMYK: colors.CMYK = {
		format: 'cmyk',
		value: { cyan: 10, magenta: 10, yellow: 10, key: 10 }
	};
	const validHex: colors.Hex = { format: 'hex', value: { hex: '#aaaaaa' } };
	const validHSL: colors.HSL = {
		format: 'hsl',
		value: { hue: 120, saturation: 50, lightness: 50 }
	};
	const validHSV: colors.HSV = {
		format: 'hsv',
		value: { hue: 240, saturation: 50, value: 50 }
	};
	const validLAB: colors.LAB = {
		format: 'lab',
		value: { l: 50, a: 0, b: 0 }
	};
	const validRGB: colors.RGB = {
		format: 'rgb',
		value: { red: 100, green: 100, blue: 100 }
	};
	const validXYZ: colors.XYZ = {
		format: 'xyz',
		value: { x: 0.9505, y: 1, z: 1.0891 }
	};
	...
	describe('CMYK Limits', () => {
		it('should identify bright CMYK correctly', () => {
			const brightCMYK = {
				...validCMYK,
				value: { cyan: 5, magenta: 5, yellow: 5, key: 0 }
			};
		...
		it('should identify dark CMYK correctly', () => {
			const darkCMYK = {
				...validCMYK,
				value: { cyan: 10, magenta: 10, yellow: 10, key: 95 }
			};
		...
		it('should identify gray CMYK correctly', () => {
			const grayCMYK = {
				...validCMYK,
				value: { cyan: 20, magenta: 20, yellow: 20, key: 0 }
			};
	...
	describe('HSL Limits', () => {
		it('should identify bright HSL correctly', () => {
			const brightHSL: colors.HSL = {
				format: 'hsl',
				value: { hue: 0, saturation: 100, lightness: 90 }
			};
		...
		it('should identify dark HSL correctly', () => {
			const darkHSL: colors.HSL = {
				format: 'hsl',
				value: { hue: 0, saturation: 100, lightness: 10 }
			};
		...
		it('should identify gray HSL correctly', () => {
			const grayHSL: colors.HSL = {
				format: 'hsl',
				value: { hue: 0, saturation: 5, lightness: 50 }
			};
	...
	describe('HSV Limits', () => {
		it('should identify bright HSV correctly', () => {
			const brightHSV: colors.HSV = {
				format: 'hsv',
				value: { hue: 0, saturation: 0, value: 100 }
			};
		...
		it('should identify dark HSV correctly', () => {
			const darkHSV: colors.HSV = {
				format: 'hsv',
				value: { hue: 0, saturation: 0, value: 10 }
			};
		...
		it('should identify gray HSV correctly', () => {
			const grayHSV: colors.HSV = {
				format: 'hsv',
				value: { hue: 0, saturation: 5, value: 50 }
			};
	...
	describe('RGB Limits', () => {
		...
		it('should identify gray RGB correctly', () => {
			const grayRGB: colors.RGB = {
				format: 'rgb',
				value: { red: 120, green: 120, blue: 120 }
			};
